...
//  AlphaBlending
//
//  Created by wangwenjian on 2022/2/25.
//
...
int main(int argc, const char * argv[]) {
    // insert code here...
    Mat foreGroundImage = imread("foreGroundAsset.png", -1);
    Mat bgra[4];
    ...
    Mat background = imread("backGround.jpg",CV_8UC3);
    
    foreground.convertTo(foreground, CV_32FC3);
    background.convertTo(foreground, CV_32FC3);
    ...
    cout  << "Time for alpha blending using multiply & add function :" << t * 1000/ numOfIterations << " millisenconds"  << endl;
